...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'VariationUtil'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from VariationUtil.VariationUtilImpl import VariationUtil  # noqa @IgnorePep8
impl_VariationUtil = VariationUtil(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'VariationUtil'
